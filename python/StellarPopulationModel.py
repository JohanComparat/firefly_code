...
class StellarPopulationModel:
	...
	def fit_models_to_data(self):
		...
		for mi,mm in enumerate(self.model_libs):
			...
			#print "M Msun", np.log10(self.averages['stellar_mass']), np.log10(mass_per_ssp[order])
			#print "age Gyr", np.log10(self.averages['light_age']), np.log10(self.averages['mass_age']), np.log10(age_per_ssp[order])
			#print "Z", np.log10(self.averages['light_metal']), np.log10(self.averages['mass_metal']), np.log10(metal_per_ssp[order])
			#print "SFR Msun/yr", np.log10(mass_per_ssp[order])/age_per_ssp[order]
			...
			tbhdu.header['HIERARCH age_lightW_up'] = np.log10(averages['light_age_1_sig_plus'])
			tbhdu.header['HIERARCH age_lightW_low'] = np.log10(averages['light_age_1_sig_minus'])
			tbhdu.header['HIERARCH metallicity_lightW'] = np.log10(averages['light_metal'])
			tbhdu.header['HIERARCH metallicity_lightW_up'] = np.log10(averages['light_metal_1_sig_plus'])
			tbhdu.header['HIERARCH metallicity_lightW_low'] = np.log10(averages['light_metal_1_sig_minus'])
			tbhdu.header['HIERARCH age_massW'] = np.log10(averages['mass_age']) 
			tbhdu.header['HIERARCH age_massW_up'] = np.log10(averages['mass_age_1_sig_plus']) 
			tbhdu.header['HIERARCH age_massW_low'] = np.log10(averages['mass_age_1_sig_minus'])
			tbhdu.header['HIERARCH metallicity_massW'] = np.log10(averages['mass_metal'])
			tbhdu.header['HIERARCH metallicity_massW_up'] = np.log10(averages['mass_metal_1_sig_plus'])
			tbhdu.header['HIERARCH metallicity_massW_low'] = np.log10(averages['mass_metal_1_sig_minus'])
			tbhdu.header['HIERARCH stellar_mass'] = np.log10(averages['stellar_mass'])
			tbhdu.header['HIERARCH stellar_mass_up'] = np.log10(averages['stellar_mass_1_sig_plus'])
			tbhdu.header['HIERARCH stellar_mass_low'] = np.log10(averages['stellar_mass_1_sig_minus'])
			...
			#	tbhdu.header['HIERARCH SFR_ssp_'+str(iii)] = np.log10(mass_per_ssp[order][iii])/np.log10(age_per_ssp[order][iii]
				# SFR is wrong ...
				tbhdu.header['HIERARCH SFR_ssp_'+str(iii)] = np.log10(mass_per_ssp[order][iii])/np.log10(age_per_ssp[order][iii])
