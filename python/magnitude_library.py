...
class Photo():
	...
	def loadMegacam(self):
		...
		"""
		uf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/cfht/megacam_filter/uMegacam.filter"), unpack=True)                  
		gf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/cfht/megacam_filter/gMegacam.filter"), unpack=True)
		rf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/cfht/megacam_filter/rMegacam.filter"), unpack=True)
		yf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/cfht/megacam_filter/yMegacam.filter"), unpack=True)
		zf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/cfht/megacam_filter/zMegacam.filter"), unpack=True)
	...
	def loadSDSS(self):
		...
		uf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/filter/sdss/uSDSS.filter"), unpack=True)                  
		gf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/filter/sdss/gSDSS.filter"), unpack=True)
		rf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/filter/sdss/rSDSS.filter"), unpack=True)
		yf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/filter/sdss/iSDSS.filter"), unpack=True)
		zf=np.loadtxt(os.path.join(os.environ["GIT_SPM"], "data/filter/sdss/zSDSS.filter"), unpack=True)
